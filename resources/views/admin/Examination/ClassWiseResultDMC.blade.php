...
<body cz-shortcut-listen="true" onload="window.print()">
    <!-- ============================================================== -->
                                ...
                                <div>
                                    <?php
                                     ...
                                     $section=$request->section;
                                        ...
                                        $stdentInfo = DB::select("
                                            SELECT si.*,c.ClassName,s.SectionName,t.termname,ac.Session FROM studentinfo si INNER JOIN studentmarks sm on si.studentid=sm.studentid and
                                            si.campusid=sm.campusid and si.admissioninclass=sm.classid and si.admissioninsection=sm.sectionid
                                            and si.status='Active'
                                            INNER JOIN classes c on c.campusid=si.campusid and c.C_id=si.admissioninclass INNER JOIN
                                            sections s on s.campusid=si.campusid and s.Sec_ID=si.admissioninsection
                                            INNER join academicsessions ac on ac.CampusID=si.campusid and si.session=ac.id and si.session=sm.sessionid INNER JOIN termnames t
                                            on t.id=sm.termid and 
                                            si.admissioninclass='$class' and si.admissioninsection='$section' and sm.termid='$term' 
                                            and sm.sessionid='$session'
                                            group by si.studentid

                                          ");

                                      
                                          $limt=Count($stdentInfo);
                        //  dd($stdentInfo); 
                                        $index=0;        
                                 while ($index<$limt) {
                                            # code...
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                           ...
                                                           ?>
                                                            ...
                                                            <th><u>
                                                                    <b>
                                                                        <?php echo $stdentInfo[$index]->studentname; ?>
                                                                    </b>
                                                                </u></th>
                                                            <th>Father Name</th>
                                                            <th><u><b>{{ $stdentInfo[$index]->fathername }}</b></u></th>
                                                            <th>Admn. No.</th>
                                                            <th><u><b>{{ $stdentInfo[$index]->studentid }}</b></u></th>
                                                        </tr>
                                                        <tr>
                                                            <th>Class:</th>
                                                            <th><u><b>{{ $stdentInfo[$index]->ClassName }}</b></u></th>
                                                            <th>Section:</th>
                                                            <th><u><b>{{ $stdentInfo[$index]->SectionName }}</b></u>
                                                            </th>
                                                            <th>D.O.B</th>
                                                            <th><u><b>{{ $stdentInfo[$index]->dob }}</b></u></th>
                                                        </tr>
                                                        <tr>
                                                            <th>Address</th>
                                                            <th><u>
                                                                    <b>
                                                                        <?php  if($stdentInfo[$index]->address1){ echo $stdentInfo[$index]->address1; }else{ echo '_________';} ?>
                                                                    </b>
                                                                </u></th>
                                                            <th>Session</th>
                                                            <th><u><b>{{ $stdentInfo[$index]->Session }}</b></u></th>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <div class="" style="border: 1px solid">
                                                        ...
                                                        <center>
                                                            <h3> &nbsp;<b class="text-danger">{{
                                                                    $stdentInfo[$index]->termname ." ".
                                                                    $stdentInfo[$index]->Session }}</b>
                                                            </h3>
                                                        </center>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-7 col-sm-7 mt-3">
                                                    ...
                                                    <table class="table " style="width:100%;border:1px solid">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $stdid=$stdentInfo[$index]->studentid;       
                                                            $indexSubject = 0;
                                                            $subjectSNO=1;
                                                            $StudentSubjects = DB::select("
                                                                SELECT sm.*,cs.name as subjectName,cs.sequence FROM studentinfo si INNER JOIN studentmarks sm on si.studentid=sm.studentid and
                                                                si.campusid=sm.campusid and si.admissioninclass=sm.classid and si.admissioninsection=sm.sectionid
                                                                and si.status='Active'
                                                                INNER JOIN subjects cs on cs.campusid=sm.campusid 
                                                                and cs.id=sm.subjectid and cs.isdisplay=1                   
                                                                INNER JOIN classes c on c.campusid=si.campusid and c.C_id=si.admissioninclass INNER JOIN
                                                                sections s on s.campusid=si.campusid and s.Sec_ID=si.admissioninsection
                                                                INNER join academicsessions ac on ac.CampusID=si.campusid and si.session=ac.id and si.session=sm.sessionid INNER JOIN termnames t
                                                                on t.id=sm.termid and 
                                                                si.admissioninclass='$class' and si.admissioninsection='$section' and sm.termid='$term' 
                                                                and sm.sessionid='$session' and  sm.studentid='$stdid'
                                                            ...
                                                            $pds = \DB::select("SELECT pds.id, pd.pname, pds.comment FROM `personal_development_stores` pds, personal_developments pd
                                                                ...
                                                                AND pds.sessionid = '$session' AND pds.termid = '$term'");

                                                            
                                                                $Subjectlimt=Count($StudentSubjects);
                                                                                        $j = 1;
                                                                                        $maxt = 0;
                                                                                        $obtt = 0;
                                                                                        $maxp = 0;
                                                                                        $obtp = 0;
                                                                while($indexSubject< $Subjectlimt){                  
                                
                                                                ?>

                                                            <tr id="idd" class="subjectRow">
                                                                <td class="text-center" id="idd">{{$subjectSNO}}</td>
                                                                <td id="idd" class="text-left">{{
                                                                    $StudentSubjects[$indexSubject]->subjectName }}</td>
                                                                <td class="text-center" id="idd">{{
                                                                    $StudentSubjects[$indexSubject]->total_marks_theory
                                                                    }}</td>
                                                                <?php $maxt += $StudentSubjects[$indexSubject]->total_marks_theory; ?>
                                                                <td class="text-center" id="idd">{{
                                                                    $StudentSubjects[$indexSubject]->obtain_marks_theory
                                                                    }}</td>
                                                                <?php $obtt += $StudentSubjects[$indexSubject]->obtain_marks_theory; ?>
                                                                <td class="text-center" id="idd">{{
                                                                    $StudentSubjects[$indexSubject]->total_marks_practical
                                                                    }}</td>
                                                                <?php $maxp += $StudentSubjects[$indexSubject]->total_marks_practical; ?>
                                                                <td class="text-center" id="idd">{{
                                                                    $StudentSubjects[$indexSubject]->obtain_marks_practical
                                                                    }}</td>
                                                                <?php $obtp += $StudentSubjects[$indexSubject]->obtain_marks_practical; ?>
                                                                <td class="text-center" id="idd">{{
                                                                    $StudentSubjects[$indexSubject]->total_marks_theory
                                                                    +
                                                                    $StudentSubjects[$indexSubject]->total_marks_practical
                                                            ...
                                                            <tr id="idd">
                                                                ...
                                                                <td class="text-center" id="idd"><b>{{$maxt +
                                                                        $maxp}}</b></td>
                                                                <td class="text-center" id="idd"><b>{{$obtt +
                                                                        $obtp}}</b></td>
                                                            </tr>
                                                    ...
                                                    <table class="table" style="width: 100%; border:1px solid">
                                                        <tbody>
                                                            ...
                                                            <tr id="idd">
                                                                ...
                                                                <td class="text-center hello" id="">@if ($pd->comment ==
                                                                    'E')
                                                                    {{"Excellent"}}
                                                                    @elseif($pd->comment == 'S')
                                                                    {{"Satisfactory"}}
    ...
    {{-- <footer class="footer text-center">
        Copyright © 2021 Peshawar Model Schools. For Queries, Complaints and Suggestions Please write to us
        queries@pmei.edu.pk
    </footer> --}}
