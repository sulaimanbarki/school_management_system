                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                <div class="m-b-25"> <img src="<?php if(empty($userData->profile_photo_path))
                                	{
                                		echo 'https://img.icons8.com/bubbles/100/000000/user.png';
                                	}else{
                                		echo $userData->profile_photo_path;
                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted f-w-400">03139247678</h6>
                                    </div>
                                </div>
                                ...
                                <ul class="social-link list-unstyled m-t-40 m-b-10">
                                  ...
                                  <a href="{{ route('user.profile.edit') }}">  <button class="btn btn-success">Edit Profile</button></a>
                                </ul>
                            </div>
                        </div>
                    </div>
