      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="card card-secondary">
            ...
            <div class="card-body">
              <div class="form-group">
                <label for="inputEstimatedBudget">Company Name</label>
              ...
              <div class="form-group">
                <label for="inputSpentBudget">Date Of Registration</label>
              ...
              <div class="form-group">
                <label for="inputEstimatedDuration">Company Logo</label>
                <input type="file"  id="logo" class="form-control">
              </div>
              <button class="btn btn-success" id="addCompany">Submit</button>
            </div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="inputStatus">Sttuatus</label>
                <select id="inputStatus" class="form-control custom-select">
                  <option selected disabled>Select one</option>
                  <option>On Hold</option>
                  <option>Canceled</option>
